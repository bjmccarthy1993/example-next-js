...
export default function EditInvoiceForm({
  ...
  // We cannot pass the id as an argument in the form action, so we create a new function with the id preset
  ...
  return (
    <form action={formAction} aria-describedby="update-invoice-error">
